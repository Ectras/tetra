...
mod tests {
    ...
    fn contraction_one_hyperedge_one_normal() {
        ...
        let mut solution = Tensor::new_from_flat(&[3, 3], solution_data, None);
        let b = Tensor::new_from_flat(&[1, 3, 2, 1], b_data, None);
        let c = Tensor::new_from_flat(&[3, 2, 1, 3], c_data, None);

        let mut out = contract(&[1, 4], &[0, 1, 2, 3], &b, &[4, 2, 3, 1], &c);
    ...
    fn contraction_three_hyperedges_only() {
        let b_data = vec![
            Complex64::new(0.44122748688504143, 1.1513910094871702),
            Complex64::new(0.18760322583703548, 0.996439826913362),
            Complex64::new(0.10960984157818278, -0.9806078852186219),
            Complex64::new(-0.3588289470012431, 0.0032888429341100755),
            Complex64::new(2.43077118700778, -1.5111795576883658),
            Complex64::new(-1.192764612421806, 0.059144243219039896),
            Complex64::new(-0.9092324048562419, -0.8718791832556535),
            Complex64::new(-1.6647885294716944, 0.7930533194619698),
            Complex64::new(-0.33087015189408764, 1.8573310072313118),
            Complex64::new(-0.32986995777935924, 0.7124212708765678),
            Complex64::new(1.5824811170615634, -0.8568531547160899),
            Complex64::new(0.6034716026094954, -0.10593044205742323),
            Complex64::new(-0.2520921296030769, 0.6448475108927784),
            Complex64::new(-0.2048765105875873, -0.3633108784819174),
            Complex64::new(-0.5916366579302884, -0.4225079291623943),
            Complex64::new(-0.7001790376899514, -0.6315716297922155),
        ];
        let c_data = vec![
            Complex64::new(-0.0061949084857593475, -0.3058530211666308),
            Complex64::new(0.19766009104249851, 0.269612406446701),
            Complex64::new(-0.05230815085185874, 0.1007381887528521),
            Complex64::new(-0.08687560627763552, 1.1393429788252842),
            Complex64::new(-0.10106761180924467, -0.47773141727821256),
            Complex64::new(1.3348485742415819, 1.2919633833879631),
            Complex64::new(0.24921765856490757, 0.3554384723493521),
            Complex64::new(1.5615322934488904, 0.49444039812108825),
        ];
        let solution_data = vec![
            Complex64::new(0.6530250015496062, -0.20563538876280618),
            Complex64::new(-0.4417080314012201, 0.21783509802596068),
            Complex64::new(-0.8234390459060414, 0.3297937382425563),
            Complex64::new(4.161797024370362, 1.5390005601760346),
            Complex64::new(0.08151757292578188, 0.20066782225940133),
            Complex64::new(-0.613473725741819, -0.9345508659017919),
            Complex64::new(-0.2810673577529987, -0.5451026773746281),
            Complex64::new(-1.4960324091143284, -2.284705138013529),
        ];

        let mut solution = Tensor::new_from_flat(&[2, 2, 2], solution_data, None);
        let b = Tensor::new_from_flat(&[2, 2, 2, 2], b_data, None);
        let c = Tensor::new_from_flat(&[2, 2, 2], c_data, None);

        let mut out = contract(&[3, 2, 0], &[1, 3, 0, 2], &b, &[2, 0, 3], &c);
